...
const Topbar = () => {
  return (
    <div>
        <div className="container-fluid bg-dark px-5 d-none d-lg-block py-2">
            ...
            <div className="row gx-0 align-items-center">
                ...
                <div className="col-lg-4 text-center text-lg-end">
                    <div className="d-flex align-items-center justify-content-end">
                        <a href="#" className="me-3 text-white">Login</a>
                        <span>|</span>
                        <a href="#" className="ms-3 text-white">Register</a>
                    </div>
                </div>
            </div>
        </div>
